...
async function createBrowser() {
    ...
    await page.evaluateOnNewDocument(() => {
        ...
        // Overwrite the plugins to use a standard set
        ...
        // Add a chrome object if it doesn't exist
        if (!window.chrome) {
            window.chrome = {};
...
app.get("/download", async (req, res) => {
    ...
    try {
        ...
        console.log(`✅ Successfully processed request for ${title}`);
        res.json(result);
    } catch (error) {
...
// Clear cache endpoint (protected with a simple key)
